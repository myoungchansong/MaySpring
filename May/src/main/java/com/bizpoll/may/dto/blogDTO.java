...
public class blogDTO {
	...
	public blogDTO(String title, String content, String writer, String filename, int filesize) {
		super();
		this.title = title;
	...
	public String toString() {
		return "blogDTO [bno=" + bno + ", title=" + title + ", content=" + content + ", writer=" + writer + ", regdate="
