...
<body>
	<div id="body_div">
		<header>
			...
			<div id="header_div">
				<a href="${path}/index"> <img alt="may" src="${path}/img/Logo_002.png">
				</a>
			</div>
			<h2 id="mm">회원가입</h2>
		</header>
		...
		<section>
			...
			<form action="${path}/member/Insert" method="POST" name="frm_mem"
				id="frm_mem">
				...
				<div id="insert_pw2" class="insert_div">
					<label for="input_pw2" class="insert_label " id="pw2">
						PASSWORD2 </label> <input type="password" id="input_pw2" name="pw"
						class="input_class ckeckpw"> <span class="error">필수
						정보입니다 </span>
				</div>
				...
				<div id="insert_name" class="insert_div">
					<label for="input_name" class="insert_label" id="name">
						NAME </label> <input type="text" id="input_name" name="name"
				...
				<div id="insert_ph" class="insert_div">
					<label for="input_ph" class="insert_label" id="phone">
						...
						name="phone" class="input_class" maxlength=11> <span
